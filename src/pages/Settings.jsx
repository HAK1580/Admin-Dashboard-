...
const Settings = () => {
  return (
     <div className='sm:w-[85%] h-screen lg:w-[95%]' >
      <h1 className='text-3xl px-6 sm:py-5  lg:hidden ' >Settings  </h1>
      <div className="add-content-here">
        <h1 className="text-lg text-red-500 text-center">YOUR CONTENT HERE </h1>
